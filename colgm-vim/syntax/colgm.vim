...
" --- Keywords ---
syntax keyword colgmKeyword func pub var return struct enum union match use if else elsif for while foreach forindex impl break continue nil true false 
